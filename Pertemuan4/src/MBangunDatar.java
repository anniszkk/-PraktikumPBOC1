...
public class MBangunDatar {
    public static void main(String[] args) {
        ...
        BD2.printInfo();
        System.out.println();
        System.out.println("2. Cek mutator untuk bangun datar BD1 yang belum punya data");
        BD1.setJmlSisi(5);
        BD1.setWarna("pink");
        BD1.setBorder("hitam");
        BD1.printInfo();
        ...
        System.out.println("Bangun datar BD2 punya jumlah sisi: " + BD2.getJmlSisi());
        System.out.println("Bangun datar BD2 punya warna: " + BD2.getWarna());
        System.out.println("Bangun datar BD2 punya border: " + BD2.getBorder());
        System.out.println();
        System.out.println("4. Cek method lainnya, yaitu printCounterBangunDatar");
